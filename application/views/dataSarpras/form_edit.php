            ...
            <div class="col-12">
                <div class="card shadow-lg">
                    <div class="card-header bg-primary text-white">
                        <h4><i class="fas fa-box"></i> Form Edit Data Sarpras</h4>
                    </div>
                    <div class="card-body">
                        <form id="formPengajuan" action="<?= base_url('dataSarpras/edit') ?>" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Masukkan Nama Barang" value="<?= isset($nama_barang) ? $nama_barang : set_value('nama_barang') ?>" required>
                            </div>
